...
class TestMenuItems(APIBase):
    ...
    def test_comms_unkill_all(self):
        ...
        result = self._execute_action("comms_unkill_all", msg="test_comms_unkill_all")
    ...
    def test_comms_kill_all(self):
        """Post a dev.enabled() command to the Indigo Web Server."""
        result = self._execute_action("comms_kill_all", msg="test_comms_kill_all")
    ...
    def test_log_plugin_environment(self):
        ...
        result = self._execute_action("log_plugin_environment", msg="test_log_plugin_environment")
    ...
    def test_refresh_weather_data(self):
        ...
        result = self._execute_action("refresh_weather_data", msg="test_refresh_weather_data")
    ...
    def test_send_weather_emails(self):
        ...
        result = self._execute_action("send_weather_emails", msg="test_send_weather_emails")
    ...
    def test_dump_the_json(self):
        ...
        result = self._execute_action("dump_the_json", msg="test_dump_the_json")
